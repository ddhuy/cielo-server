...
class RackInfo ( Document ) :
    ...
    Type = fields.StringField(max_length = 255, required = True, null = False, blank = False, choices = RACK_TYPES, default = RACK_TYPE_DEFAULT)
    Status = fields.StringField(max_length = 255, required = True, null = True, blank = True, choices = RACK_STATUSES, default = RACK_STT_DEFAULT)
